export default {
	...
	Clock: {
		name: 'Clock',
		alt: 'A clock set to approximately ten past ten.',
		keywords: ['clock', 'time'],
	},
	...
	ConicalFlask: {
		name: 'Conical Flask',
		alt: 'Conical flask like those used in chemistry.',
	...
	HiraShuriken: {
		...
		props: {
			...
			indent:
				'is the distance up the leg to form inner corner between 0 and 1, defaults to 0.3',
		},
	},
	HorseShoe: {
		name: 'Horseshoe',
	...
	Parallelogram: {
		...
		props: {
			slope:
				'is the angle in degrees, negative for left leaning, defaults to 15',
		},
	},
	Parenthesis: {
		name: 'Parenthesis',
	...
	RegularPolygon: {
		...
		props: {
			sides:
				'is the number of sides as positive integer greater than 2, defaults to 5',
		},
	},
	RightTriangle: {
	...
	Star: {
		...
		props: {
			...
			indent:
				'is the distance up the leg to form inner corner between 0 and 1, defaults to 0.33',
		},
	},
	TiPi: {
		name: 'TiPi',
